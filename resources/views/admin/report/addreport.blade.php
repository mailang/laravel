            ...
            <div class="col-md-12"> <div class="col-md-1"></div>
                <table style="width: 990px;" width="1118">
                    ...
                    <tr style="height:39.38pf">
                        ...
                        <td  width="195">
                            报送日期：{{date('Y年m月', strtotime('-1 month'))}}
                        </td>
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    <input class="form-control" type="text" id="total_capital" name="total_capital"
                                           check-type="number required" placeholder="资产总额" value="">
                            ...
                            <div class="form-group">
                                <div class="input-group ">
                                    <input class="form-control" id="other_capital" name="other_capital"
                                           placeholder="其他资金" type="text" check-type="number required" value="">
                                    <span class="input-group-addon">万元</span>
                                </div>
                            </div>
                        </td>
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    <input check-type="number required" class="form-control" type="text"
                                           placeholder="负债总额" name="total_debtcapital" id="total_debtcapital" value="">
                                    <span class="input-group-addon">万元</span>
                                </div>
                            </div>
                        </td>
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    <input class="form-control" check-type="number required" type="text"
                                           placeholder="实收资本" name="paidup_capital" id="paidup_capital" value="">
                                    <span class="input-group-addon">万元</span>
                                </div>
                            </div>
                        </td>
                    ...
                    <tr style="height:27.44pf">
                        ...
                        <td  width="132">
                            <div class="form-group">
                                <div class="input-group">
                                    <input class="form-control" check-type="number required" type="text"
                                           placeholder="营业收入" name="income" id="income" value="">
                                    <span class="input-group-addon">万元</span>
                                </div>
                            </div>
                        </td>
                    ...
                    <tr style="height:27.44pf">
                        ...
                        <td  width="132">
                            <div class="form-group">
                                <div class="input-group">
                                    <input class="form-control" check-type="number required" type="text"
                                           placeholder="净利润" name="profit_income" id="profit_income" value=""/>
                                    <span class="input-group-addon">万元</span>
                                </div>
                            </div>
                        </td>
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    <input class="form-control" check-type="number required" placeholder="贷款余额"
                                           type="text" name="loan_remainder" id="loan_remainder" value="">
                                    <span class="input-group-addon">万元</span>
                                </div>
                            </div>
                        </td>
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    <input class="form-control" check-type="integer required" placeholder="贷款户数"
                                           type="text" name="loan_family" id="loan_family" value="">
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    <input class="form-control" check-type="number required" placeholder="本年发放贷款金额"
                                           type="text" name="year_issueloan" id="year_issueloan" value="">
                                    <span class="input-group-addon">万元</span>
                                </div>
                            </div>
                        </td>
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    <input class="form-control" check-type="integer required" placeholder="本年内发放贷款户数"
                                           type="text" name="year_issuefamily" id="year_issuefamily" value="">
                                    <span class="input-group-addon">户</span>
                                </div>
                            </div>
                        </td>
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    <input class="form-control" check-type="integer required" placeholder="发放贷款笔数"
                                           type="text" name="year_issuenum" id="year_issuenum" value="">
                                </div>
                            </div>
                        </td>
                    </tr>
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    <input class="form-control" check-type="number required" placeholder="本年收回贷款金额"
                                           type="text" name="year_backloan" id="year_backloan" value="">
                                    <span class="input-group-addon">万元</span>
                                </div>
                            </div>
                        </td>
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    <input class="form-control" check-type="integer required" placeholder="收回贷款户数"
                                           type="text" name="year_backfamily" id="year_backfamily" value="">
                                    <span class="input-group-addon">户</span>
                                </div>
                            </div>
                        </td>
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    <input class="form-control" check-type="integer required" placeholder="收回贷款笔数"
                                           type="text" name="year_backnum" id="year_backnum" value="">
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    <input class="form-control" check-type="number required" placeholder="涉农贷款金额"
                                           type="text" name="farmer_loan_remainder" id="farmer_loan_remainder" value="">
                                    <span class="input-group-addon">万元</span>
                                </div>
                            </div>
                        </td>
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    <input class="form-control" check-type="integer required" placeholder="涉农贷款户数"
                                           type="text" name="farmer_loan_family" id="farmer_loan_family" value="">
                                    <span class="input-group-addon">户</span>
                                </div>
                            </div>
                        </td>
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    <input class="form-control" check-type="number required" placeholder="累计发放金额"
                                           type="text" name="farmer_issue" id="farmer_issue" value="">
                                    <span class="input-group-addon">万元</span>
                                </div>
                            </div>
                        </td>
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    <input class="form-control" check-type="integer required" placeholder="累计发放户数"
                                           type="text" name="farmer_backnum" id="farmer_backnum" value="">
                                    <span class="input-group-addon">户</span>
                                </div>
                            </div>
                        </td>
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    <input class="form-control" check-type=" required" placeholder="涉农贷款户数" type="text"
                                           name="company_loan_family" id="company_loan_family" value="">
                                    <span class="input-group-addon">户</span>
                                </div>
                            </div>
                        </td>
                    ...
                    <tr style="height:27.44pf">
                        ...
                        <td  width="132">
                            <div class="form-group">
                                <div class="input-group">
                                    <input class="form-control" check-type="number required" placeholder="累计发放金额"
                                           type="text" name="company_issue" id="company_issue" value="">
                                    <span class="input-group-addon">万元</span>
                                </div>
                            </div>
                        </td>
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    <input class="form-control" check-type="required" placeholder="累计发放户数" type="text"
                                           name="company_backnum" id="company_backnum" value="">
                                    <span class="input-group-addon">户</span>
                                </div>
                            </div>
                        </td>
                    ...
                    <tr style="height:27.44pf">
                        ...
                        <td  width="132">
                            <div class="form-group">
                                <div class="input-group">
                                    <input class="form-control" check-type="number required" placeholder="涉农贷款金额"
                                           type="text" name="total_remainder" id="total_remainder" value="">
                                    <span class="input-group-addon">万元</span>
                                </div>
                            </div>
                        </td>
                    ...
                    <tr style="height:27.44pf">
                        ...
                        <td  width="132">
                            <div class="form-group">
                                <div class="input-group">
                                    <input class="form-control" check-type="integer required" placeholder="涉农贷款户数"
                                           type="text" name="total_loan_family" id="total_loan_family" value="">
                                    <span class="input-group-addon">户</span>
                                </div>
                            </div>
                        </td>
                    ...
                    <tr style="height:27.44pf">
                        ...
                        <td  width="132">
                            <div class="form-group">
                                <div class="input-group">
                                    <input class="form-control" check-type="number required" placeholder="累计发放金额"
                                           type="text" name="total_issue" id="total_issue" value="">
                                    <span class="input-group-addon">万元</span>
                                </div>
                            </div>
                        </td>
                    ...
                    <tr style="height:27.44pf">
                        ...
                        <td  width="132">
                            <div class="form-group">
                                <div class="input-group">
                                    <input class="form-control" check-type="integer required" placeholder="累计发放户数"
                                           type="text" name="total_backnum" id="total_backnum" value="">
                                    <span class="input-group-addon">户</span>
                                </div>
                            </div>
                        </td>
                    ...
                    <tr style="height:27.44pf">
                        ...
                        <td  width="132">
                            <div class="form-group">
                                <div class="input-group">
                                    <input class="form-control" check-type="number required" placeholder="涉农贷款金额"
                                           type="text" name="person_loan_remainder" id="person_loan_remainder" value="">
                                    <span class="input-group-addon">万元</span>
                                </div>
                            </div>
                        </td>
                    ...
                    <tr style="height:27.44pf">
                        ...
                        <td  width="132">
                            <div class="form-group">
                                <div class="input-group">
                                    <input class="form-control" check-type="integer required" placeholder="涉农贷款户数"
                                           type="text" name="person_loan_family" id="person_loan_family" value="">
                                    <span class="input-group-addon">户</span>
                                </div>
                            </div>
                        </td>
                    ...
                    <tr style="height:27.44pf">
                        ...
                        <td  width="132">
                            <div class="form-group">
                                <div class="input-group">
                                    <input class="form-control" check-type="number required" placeholder="累计发放金额"
                                           type="text" name="person_issue" id="person_issue" value="">
                                    <span class="input-group-addon">万元</span>
                                </div>
                            </div>
                        </td>
                    ...
                    <tr style="height:27.44pf">
                        ...
                        <td  width="132">
                            <div class="form-group">
                                <div class="input-group">
                                    <input class="form-control" check-type="integer required" placeholder="累计发放户数"
                                           type="text" name="person_backnum" id="person_backnum" value="">
                                    <span class="input-group-addon">户</span>
                                </div>
                            </div>
                        </td>
                    ...
                    <tr style="height:27.44pf">
                        ...
                        <td  width="132">
                            <div class="form-group">
                                <div class="input-group">
                                    <input class="form-control" check-type="number required"
                                           type="text" placeholder="净利润" name="normal_loan_remainder" id="normal_loan_remainder" value=""/>
                                    <span class="input-group-addon">万元</span>
                                </div>
                            </div>
                        </td>
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    <input class="form-control" check-type="number required"
                                           ...
                                           name="month_loan_remainder" id="month_loan_remainder" value=""/>
                                    <span class="input-group-addon">万元</span>
                                </div>
                            </div>
                        </td>
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    <input class="form-control" check-type="number required" type="text"
                                           ...
                                           id="quarter_loan_remainder" value=""/>
                                    <span class="input-group-addon">万元</span>
                                </div>
                            </div>
                        </td>
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    <input class="form-control" check-type="number required" type="text"
                                           ...
                                           id="ninety_loan_remainder" value=""/>
                                    <span class="input-group-addon">万元</span>
                                </div>
                            </div>
                        </td>
                    ...
                    <tr style="height:27.44pf">
                        ...
                        <td  width="132">
                            <div class="form-group">
                                <div class="input-group">
                                    <input class="form-control" check-type="number required" type="text"
                                           placeholder="最高利率" name="highest_interest" id="highest_interest" value=""/>
                    ...
                    <tr style="height:27.44pf">
                        ...
                        <td  width="132">
                            <div class="form-group">
                                <div class="input-group">
                                    <input class="form-control" check-type="number required" type="text"
                                           placeholder="最低利率" name="lowest_interest" id="lowest_interest" value=""/>
                                    <span class="input-group-addon">%</span>
                                </div>
                            </div>
                        </td>
                    ...
                    <tr style="height:37.50pf">
                        ...
                        <td  width="132">
                            <div class="form-group">
                                <div class="input-group">
                                    <input class="form-control" check-type="number required" type="text"
                                           placeholder="加权平均利率" name="Average_interest" id="Average_interest" value=""/>
                                    <span class="input-group-addon">%</span>
                                </div>
                            </div>
                        </td>
                    ...
                    <tr style="height:37.50pf">
                        ...
                        <td  width="132">
                            <div class="form-group">
                                <div class="input-group">
                                    <input class="form-control" check-type="number required" type="text"
                                           placeholder="正常类贷款" name="normal_loan" id="normal_loan" value=""/>
                                    <span class="input-group-addon">万元</span>
                                </div>
                            </div>
                        </td>
                    ...
                    <tr style="height:42.50pf">
                        ...
                        <td  width="132">
                            <div class="form-group">
                                <div class="input-group">
                                    <input class="form-control" check-type="number required" type="text"
                                           placeholder="关注类贷款" name="follow_loan" id="follow_loan" value=""/>
                                    <span class="input-group-addon">万元</span>
                                </div>
                            </div>
                        </td>
                    ...
                    <tr style="height:33.75pf">
                        ...
                        <td  width="132">
                            <div class="form-group">
                                <div class="input-group">
                                    <input class="form-control" check-type="number required" type="text"
                                           placeholder="次级类贷款" name="second_loan" id="second_loan" value=""/>
                                    <span class="input-group-addon">万元</span>
                                </div>
                            </div>
                        </td>
                    ...
                    <tr style="height:36.25pf">
                        ...
                        <td  width="132">
                            <div class="form-group">
                                <div class="input-group">
                                    <input class="form-control" check-type="number required" type="text"
                                           placeholder="可疑类贷款" name="doubt_loan" id="doubt_loan" value=""/>
                                    <span class="input-group-addon">万元</span>
                                </div>
                            </div>
                        </td>
                    ...
                    <tr style="height:37.50pf">
                        ...
                        <td  width="132">
                            <div class="form-group">
                                <div class="input-group">
                                    <input class="form-control" check-type="number required" type="text"
                                           placeholder="损失类贷款" name="noback_loan" id="noback_loan" value=""/>
                                    <span class="input-group-addon">万元</span>
                                </div>
                            </div>
                        </td>
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    <input class="form-control" check-type="number required" type="text"
                                           ...
                                           id="credit_loan_remainder" value=""/>
                                    <span class="input-group-addon">万元</span>
                                </div>
                            </div>
                        </td>
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    <input class="form-control" check-type="number required" type="text"
                                           ...
                                           id="promise_loan_remainder" value=""/>
                                    <span class="input-group-addon">万元</span>
                                </div>
                            </div>
                        </td>
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    <input class="form-control" check-type="number required" type="text"
                                           ...
                                           id="mortgage_loan_remainder" value=""/>
                                    <span class="input-group-addon">万元</span>
                                </div>
                            </div>
                        </td>
                            ...
                            <div class="form-group">
                                <div class="input-group ">
                                    <input class="form-control" check-type="integer required" id="other_loan_family"
                                           name="other_loan_family" placeholder="其他方式户数" type="text" value="">
                                    <span class="input-group-addon">户</span>
                                </div>
                            </div>
                        </td>
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    <input class="form-control" check-type="number required" placeholder="银行融资"
                                           name="bank_financing" type="text" id="bank_financing" value="">
                                    <span class="input-group-addon">万元</span>
                                </div>
                            </div>
                        </td>
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    <input class="form-control" check-type="number required" placeholder="股东借款"
                                           type="text" name="shareholder_loan" id="shareholder_loan" value="">
                                    <span class="input-group-addon">万元</span>
                                </div>
                            </div>
                        </td>
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    <input class="form-control" check-type="number required" placeholder="资产、资产收益权转让"
                                           name="profit_transfer" type="text" id="profit_transfer" value="">
                                    <span class="input-group-addon">万元</span>
                                </div>
                            </div>
                        </td>
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    <input class="form-control" check-type="number required" placeholder="债券、票据(包括私募债)"
                                           type="text" name="bond_bill" id="bond_bill" value="">
                                    <span class="input-group-addon">万元</span>
                                </div>
                            </div>
                        </td>
                    ...
                    <tr style="height:27.44pf">
                        ...
                        <td  width="132">
                            <div class="form-group">
                                <div class="input-group">
                                    <input class="form-control" check-type="number required"
                                           placeholder="小贷公司同业拆借、小额再贷款" type="text" name="parterner_loan" value=""
                                           id="parterner_loan">
                                    <span class="input-group-addon">万元</span>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    <input class="form-control" check-type="number required" placeholder="资产证券化"
                                           type="text" name="securitisation" id="securitisation" value="">
                                    <span class="input-group-addon">万元</span>
                                </div>
                            </div>
                        </td>
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    <input class="form-control" check-type="number required" placeholder="资本市场挂牌"
                                           type="text" name="market_capital" id="market_capital" value="">
                                    <span class="input-group-addon">万元</span>
                                </div>
                            </div>
                        </td>
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    <input class="form-control" check-type="number required" placeholder="今年内累计纳税支出"
                                           type="text" name="paytaxes" id="paytaxes" value="">
                                    <span class="input-group-addon">万元</span>
                                </div>
                            </div>
                        </td>
